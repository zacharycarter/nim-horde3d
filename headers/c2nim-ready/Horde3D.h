...
*/
/*extern "C" */const char *h3dGetVersionString();

/* Function: h3dCheckExtension
		Checks if an extension is part of the engine library.
	
	Details:
		This function checks if a specified extension is contained in the extern "C"/shared object of the engine.
...
*/
/*extern "C" */bool h3dCheckExtension( const char *extensionName );
...
/* Function: h3dRender
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dRender( H3DNode cameraNode );
...
/* Function: h3dFinalizeFrame
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dFinalizeFrame();
...
*/
/*extern "C" */const char *h3dGetMessage( int *level, float *time );
...
*/
/*extern "C" */float h3dGetOption( H3DOptions param );
...
*/
/*extern "C" */bool h3dSetOption( H3DOptions param, float value );
...
*/
/*extern "C" */float h3dGetStat( H3DStats param, bool reset );
...
/* Function: h3dShowOverlays
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dShowOverlays( const float *verts, int vertCount, float colR, float colG, float colB,
...
/* Function: h3dClearOverlays
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dClearOverlays();
...
*/
/*extern "C" */int h3dGetResType( H3DRes res );
...
*/
/*extern "C" */const char *h3dGetResName( H3DRes res );
...
*/
/*extern "C" */H3DRes h3dGetNextResource( int type, H3DRes start );
...
*/
/*extern "C" */H3DRes h3dFindResource( int type, const char *name );
...
*/
/*extern "C" */H3DRes h3dAddResource( int type, const char *name, int flags );
...
*/
/*extern "C" */H3DRes h3dCloneResource( H3DRes sourceRes, const char *name );
...
*/
/*extern "C" */int h3dRemoveResource( H3DRes res );
...
*/
/*extern "C" */bool h3dIsResLoaded( H3DRes res );
...
/* Function: h3dLoadResource
	...
	Returns:
		true in case of success, otherwise false
*/
/*extern "C" */bool h3dLoadResource( H3DRes res, const char *data, int size );
...
/* Function: h3dUnloadResource
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dUnloadResource( H3DRes res );
...
/* Function: h3dGetResElemCount
	...
	Returns:
		number of elements
*/
/*extern "C" */int h3dGetResElemCount( H3DRes res, int elem );
...
*/
/*extern "C" */int h3dFindResElem( H3DRes res, int elem, int param, const char *value );
...
*/
/*extern "C" */int h3dGetResParamI( H3DRes res, int elem, int elemIdx, int param );
...
/* Function: h3dSetResParamI
	...
	Returns:
		 nothing
*/
/*extern "C" */void h3dSetResParamI( H3DRes res, int elem, int elemIdx, int param, int value );
...
/* Function: h3dGetResParamF
	...
	Returns:
		value of the parameter
*/
/*extern "C" */float h3dGetResParamF( H3DRes res, int elem, int elemIdx, int param, int compIdx );
...
/* Function: h3dSetResParamF
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dSetResParamF( H3DRes res, int elem, int elemIdx, int param, int compIdx, float value );
...
*/
/*extern "C" */const char *h3dGetResParamStr( H3DRes res, int elem, int elemIdx, int param );
...
/* Function: h3dSetResParamStr
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dSetResParamStr( H3DRes res, int elem, int elemIdx, int param, const char *value );
...
*/
/*extern "C" */void *h3dMapResStream( H3DRes res, int elem, int elemIdx, int stream, bool read, bool write );
...
/* Function: h3dUnmapResStream
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dUnmapResStream( H3DRes res );
...
*/
/*extern "C" */H3DRes h3dQueryUnloadedResource( int index );
...
/* Function: h3dReleaseUnusedResources
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dReleaseUnusedResources();
...
*/
/*extern "C" */H3DRes h3dCreateTexture( const char *name, int width, int height, int fmt, int flags );
...
/* Function: h3dSetShaderPreambles
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dSetShaderPreambles( const char *vertPreamble, const char *fragPreamble );
...
*/
/*extern "C" */bool h3dSetMaterialUniform( H3DRes materialRes, const char *name, float a, float b, float c, float d );
...
/* Function: h3dResizePipelineBuffers
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dResizePipelineBuffers( H3DRes pipeRes, int width, int height );
...
*/
/*extern "C" */bool h3dGetRenderTargetData( H3DRes pipelineRes, const char *targetName, int bufIndex,
...
*/
/*extern "C" */int h3dGetNodeType( H3DNode node );
...
*/
/*extern "C" */H3DNode h3dGetNodeParent( H3DNode node );
...
*/
/*extern "C" */bool h3dSetNodeParent( H3DNode node, H3DNode parent );
...
*/
/*extern "C" */H3DNode h3dGetNodeChild( H3DNode node, int index );
...
*/
/*extern "C" */H3DNode h3dAddNodes( H3DNode parent, H3DRes sceneGraphRes );
...
/* Function: h3dRemoveNode
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dRemoveNode( H3DNode node );
...
*/
/*extern "C" */bool h3dCheckNodeTransFlag( H3DNode node, bool reset );
...
/* Function: h3dGetNodeTransform
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dGetNodeTransform( H3DNode node, float *tx, float *ty, float *tz,
...
/* Function: h3dSetNodeTransform
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dSetNodeTransform( H3DNode node, float tx, float ty, float tz,
                              float rx, float ry, float rz, float sx, float sy, float sz );
...
/* Function: h3dGetNodeTransMats
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dGetNodeTransMats( H3DNode node, const float **relMat, const float **absMat );
...
/* Function: h3dSetNodeTransMat
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dSetNodeTransMat( H3DNode node, const float *mat4x4 );
...
/* Function: h3dGetNodeParamI
	...
	Returns:
		value of the parameter
*/
/*extern "C" */int h3dGetNodeParamI( H3DNode node, int param );
...
/* Function: h3dSetNodeParamI
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dSetNodeParamI( H3DNode node, int param, int value );
...
/* Function: h3dGetNodeParamF
	...
	Returns:
		value of the parameter
*/
/*extern "C" */float h3dGetNodeParamF( H3DNode node, int param, int compIdx );
...
/* Function: h3dSetNodeParamF
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dSetNodeParamF( H3DNode node, int param, int compIdx, float value );
...
/* Function: h3dGetNodeParamStr
	...
	Returns:
		value of the property or empty string if no such property exists
*/
/*extern "C" */const char *h3dGetNodeParamStr( H3DNode node, int param );
...
/* Function: h3dSetNodeParamStr
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dSetNodeParamStr( H3DNode node, int param, const char *value );
...
/* Function: h3dGetNodeFlags
	...
	Returns:
		flag bitmask
*/
/*extern "C" */int h3dGetNodeFlags( H3DNode node );
...
/* Function: h3dSetNodeFlags
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dSetNodeFlags( H3DNode node, int flags, bool recursive );
...
/* Function: h3dGetNodeAABB
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dGetNodeAABB( H3DNode node, float *minX, float *minY, float *minZ,
...
*/
/*extern "C" */int h3dFindNodes( H3DNode startNode, const char *name, int type );
...
*/
/*extern "C" */H3DNode h3dGetNodeFindResult( int index );
...
/* Function: h3dSetNodeUniforms
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dSetNodeUniforms( H3DNode node, float *uniformData, int count );
...
/* Function: h3dCastRay
	...
	*/
/*extern "C" */int h3dCastRay( H3DNode node, float ox, float oy, float oz, float dx, float dy, float dz, int numNearest );
...
*/
/*extern "C" */bool h3dGetCastRayResult( int index, H3DNode *node, float *distance, float *intersection );
...
*/
/*extern "C" */int h3dCheckNodeVisibility( H3DNode node, H3DNode cameraNode, bool checkOcclusion, bool calcLod );
...
*/
/*extern "C" */H3DNode h3dAddGroupNode( H3DNode parent, const char *name );
...
/* Function: h3dAddModelNode
	...
	Returns:
		handle to the created node or 0 in case of failure
*/
/*extern "C" */H3DNode h3dAddModelNode( H3DNode parent, const char *name, H3DRes geometryRes );
...
/* Function: h3dSetupModelAnimStage
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dSetupModelAnimStage( H3DNode modelNode, int stage, H3DRes animationRes, int layer,
...
/* Function: h3dGetModelAnimParams
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dGetModelAnimParams( H3DNode modelNode, int stage, float *time, float *weight );
...
/* Function: h3dSetModelAnimParams
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dSetModelAnimParams( H3DNode modelNode, int stage, float time, float weight );
...
*/
/*extern "C" */bool h3dSetModelMorpher( H3DNode modelNode, const char *target, float weight );
...
/* Function: h3dUpdateModel
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dUpdateModel( H3DNode modelNode, int flags );
...
/* Function: h3dAddMeshNode
	...
	Returns:
		handle to the created node or 0 in case of failure
*/
/*extern "C" */H3DNode h3dAddMeshNode( H3DNode parent, const char *name, H3DRes materialRes, 
...
/* Function: h3dAddJointNode
	...
	Returns:
		handle to the created node or 0 in case of failure
*/
/*extern "C" */H3DNode h3dAddJointNode( H3DNode parent, const char *name, int jointIndex );
...
/* Function: h3dAddLightNode
	...
	Returns:
		handle to the created node or 0 in case of failure
*/
/*extern "C" */H3DNode h3dAddLightNode( H3DNode parent, const char *name, H3DRes materialRes,
...
/* Function: h3dAddCameraNode
	...
	Returns:
		handle to the created node or 0 in case of failure
*/
/*extern "C" */H3DNode h3dAddCameraNode( H3DNode parent, const char *name, H3DRes pipelineRes );
...
/* Function: h3dSetupCameraView
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dSetupCameraView( H3DNode cameraNode, float fov, float aspect, float nearDist, float farDist );
...
/* Function: h3dGetCameraProjMat
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dGetCameraProjMat( H3DNode cameraNode, float *projMat );
...
/* Function: h3dSetCameraProjMat
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dSetCameraProjMat( H3DNode cameraNode, float *projMat );
...
/* Function: h3dAddEmitterNode
	...
	Returns:
		handle to the created node or 0 in case of failure
*/
/*extern "C" */H3DNode h3dAddEmitterNode( H3DNode parent, const char *name, H3DRes materialRes,
...
/* Function: h3dUpdateEmitter
	...
	Returns:
		nothing
*/
/*extern "C" */void h3dUpdateEmitter( H3DNode emitterNode, float timeDelta );
...
*/
/*extern "C" */bool h3dHasEmitterFinished( H3DNode emitterNode );
